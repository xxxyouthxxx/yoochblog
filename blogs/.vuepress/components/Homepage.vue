        ...
        return {
            ...
            assets: {
                parallax_0: {
                    sort: 0,
                    delay: 100 * 6,
                    value: 'https://pic.imgdb.cn/item/6401868df144a010073d3498.png',
                    cb: () => this.$set(this.assets.parallax_0, 'done', true)
                },
                parallax_1: {
                    sort: 1,
                    delay: 100 * 5,
                    value: 'https://pic.imgdb.cn/item/6401868ef144a010073d34fd.png',
                    cb: () => this.$set(this.assets.parallax_1, 'done', true)
                },
                parallax_2: {
                    sort: 2,
                    delay: 100 * 4,
                    value: 'https://pic.imgdb.cn/item/6401868ef144a010073d353d.png',
                    cb: () => this.$set(this.assets.parallax_2, 'done', true)
                },
                parallax_3: {
                    sort: 3,
                    delay: 100 * 3,
                    value: 'https://pic.imgdb.cn/item/6401868df144a010073d33ba.png',
                    cb: () => this.$set(this.assets.parallax_3, 'done', true)
                },
                parallax_4: {
                    sort: 4,
                    delay: 100 * 2,
                    value: 'https://pic.imgdb.cn/item/6401868df144a010073d33f1.png',
                    cb: () => this.$set(this.assets.parallax_4, 'done', true)
                },
                parallax_5: {
                    sort: 5,
                    delay: 100 * 1,
                    value: 'https://pic.imgdb.cn/item/64018692f144a010073d3e15.png',
                    cb: () => this.$set(this.assets.parallax_5, 'done', true)
                },
                parallax_6: {
                    sort: 6,
                    delay: 100 * 0,
                    value: 'https://pic.imgdb.cn/item/64018692f144a010073d3dfb.png',
